...
export default function FormularioComponent(){
    return (
       <section className="flex flex-col items-center gap-5 p-4 border border-gray-400 rounded-2xl m-4 bg-white shadow-sm">
        <h2 className="text-2xl font-bold">Formulário</h2>
        <form className="flex flex-col gap-5 w-full" action={enviarRespostasDoFormulario}>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta1" id="pergunta-1" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta2" id="pergunta-2" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione a sua alternativa</option>
                    <option value="dados">Alternativa A</option>
                    <option value="ux">Alternativa B</option>
                    <option value="dev">Alternativa C</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta3" id="pergunta-3" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione a sua alternativa</option>
                    <option value="dados">Alternativa A</option>
                    <option value="ux">Alternativa B</option>
                    <option value="dev">Alternativa C</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta4" id="pergunta-4" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione a sua alternativa</option>
                    <option value="dados">Alternativa A</option>
                    <option value="ux">Alternativa B</option>
                    <option value="dev">Alternativa C</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta5" id="pergunta-5" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione a sua alternativa</option>
                    <option value="dados">Alternativa A</option>
                    <option value="ux">Alternativa B</option>
                    <option value="dev">Alternativa C</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta6" id="pergunta-6" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta7" id="pergunta-7" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione uma nota de 1 a 5</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta8" id="pergunta-8" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione uma nota de 1 a 5</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta9" id="pergunta-9" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione uma nota de 1 a 5</option>
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <select name="pergunta10" id="pergunta-10" className="p-2.5 border border-gray-400 rounded bg-white font-medium" defaultValue="">
                    <option value="" disabled>Selecione uma nota de 1 a 5</option>
            ...
            <button type="submit" className="bg-blue-500 text-white p-3 rounded-xl hover:bg-blue-600 transition-colors mt-2 font-semibold shadow-sm w-full md:w-auto md:px-10 self-center">
                Enviar Respostas
            </button>
        </form>
       </section>
